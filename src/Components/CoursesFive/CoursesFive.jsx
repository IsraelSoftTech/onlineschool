...
import InactiveCourse from '../inactiveCourse/inactiveCourse'




const CoursesFive = () => {
    const [showInactiveCourse, setShowInactiveCourse] = useState(false);
  ...
  return (
    <div>
         {showInactiveCourse && <InactiveCourse onClose={() => setShowInactiveCourse(false)} />}
<NavComponent/>
