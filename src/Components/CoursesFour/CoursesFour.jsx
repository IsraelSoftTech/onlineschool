...
<button onClick={() => setShowForm(true)} style={{background:'#007bff',borderRadius:'5px',color:'white',padding:'5px'}}>Create Course</button>
</div>
{/* _--------------------------------------------------------------left-side */}
...
<div children="course-right-side">
    ...
    <Chats/>
      ...
      {showForm && <CreateEditCourse onClose={() => setShowForm(false)} />}
        </div>
  )
}

export default CoursesFour